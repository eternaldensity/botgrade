defmodule Botgrade.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Botgrade.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    BotgradeWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
